...
export default function Home() {
  ...
  return (
    <div className="bg-gray-900 min-h-screen text-white font-bold">
      ...
      <div className="flex justify-end" id="google_translate_element"></div>
      ...
      <div className="p-3 font-mono">
        ...
        <p className="pt-5 underline">Company wallet address: <span className="text-[13px]">0x3535b244A990Ac7Fbaa4f20313fe9d393F2eD68C</span></p>

        <div className="flex justify-center pt-9 pb-10"><button onClick={ref} className={`border p-3 ${isClick ? "bg-green-600 hover-bg-green-400" : "bg-gray-600 hover-bg-gray-400"} rounded-xl`}>{isClick ? "Pending comfirmation...": "Payment completed"}</button></div>
